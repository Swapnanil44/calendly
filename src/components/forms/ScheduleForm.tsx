                ...
                {groupedAvailabilityFields[dayOfWeek]?.map(
                  (field, labelIndex) => (
                    <div className="flex flex-col gap-1" key={field.id}>
                        ...
                        <FormField
                          ...
                          render={({ field: inputField }) => (
                            <FormItem>
                              ...
                              {/* Move FormMessage here for better association */}
                              <FormMessage />
                            </FormItem>
                          )}
                        />
                      ...
                      {/* Display array-level errors (like overlap errors) */}
                      ...
                      {form.formState.errors.availabilities?.[field.index]?.startTime && (
                        <div className="text-red-500 text-sm">
                          Start time: {form.formState.errors.availabilities[field.index]?.startTime?.message}
                        </div>
                      )}
                      {form.formState.errors.availabilities?.[field.index]?.endTime && (
                        <div className="text-red-500 text-sm">
                          End time: {form.formState.errors.availabilities[field.index]?.endTime?.message}
                        </div>
                      )}
